...
new = 'sprintf(core_save_directory,"%s%cclassic-mame2000",retro_save_directory,slash);'
if old not in s:
...
new2 = 'sprintf(core_sys_directory,"%s%cclassic-mame2000",retro_system_directory,slash);'
if old2 not in s:
    raise SystemExit("core_sys_directory pattern not found")
s = s.replace(old2, new2, 1)

p.write_text(s)
print("patched MAME2000: CLASSIC namespace classic-mame2000")
