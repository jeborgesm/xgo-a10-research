/*
 * XGO Classic Arcade Test21 continuity loader.
 * Derived directly from the hardware-proven CPS1 loader.
 * Only changes: list gate 7->11 and core path -> /cores/mame2000/core.xgc.
 */
...
void load_and_run_classic_probe(const char *filename,int load_state)
{
    FILE *f=0;
    xgoc_header h;
